...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        UserWithPermsResponse userWithPerms = userService.findWithRolesAndPermissionsByEmail(email);
        ...
        final boolean validToken = jwtTokenManager.validateToken(authToken, userWithPerms.getEmail());
